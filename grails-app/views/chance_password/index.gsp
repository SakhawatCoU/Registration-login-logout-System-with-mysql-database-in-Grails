                ...
                <div class="row">
                    <div class="col-lg-6 m-md-auto">
                        <div class="table_content">
                            <form controller="chance_password" action="index">

                                    <div class="form-group">
                                        <label >Previous Password:</label>
                                        <input style="font-size: 12px" type="text" class="form-control"  placeholder="Previous password" required="required" name="prepassword" >
                                    </div>
                                    <div class="form-group">
                                        <label >New Password:</label>
                                        <input  style="font-size: 12px" type="text" class="form-control"  placeholder="New password" required="required" name="newpassword">
                                    </div>
                                    <div class="form-group">
                                        <label >Confirme Password:</label>
                                        <input style="font-size: 12px" type="text" class="form-control"  placeholder="Enter password" required="required" name="conpassword">
                                    </div>
                                    <div class="form-group">
